                                        ...
                                        ?>
                                          <tr class="gradeX">
                                              ...
                                              <td  style="color: #000000;">
                                                <a href="<?php echo base_url(); ?>cetak/cetak_su_desa/<?php echo $desa->kode_desa; ?>/<?php echo $desa->jumlah; ?>" target="_blank"class="waves-effect waves-light btn blue btn tooltipped"data-position="bottom" data-delay="50" data-tooltip="Cetak QR Code"><i class="material-icons dp48">local_printshop</i></a>
                                              </td>
                                          </tr>
                                          <?php
                                          }
