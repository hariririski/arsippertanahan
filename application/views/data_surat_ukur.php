                                        ...
                                        ?>
                                          <tr class="gradeX">
                                              ...
                                              <td  style="color: #000000;">
                                                <a href="<?php echo base_url(); ?>cetak/cetak_su_desa/<?php echo $desa->kode_desa; ?>/<?php echo $desa->jumlah; ?>" target="_blank"class="waves-effect waves-light btn  green">Cetak</a>
                                              </td>
                                          </tr>
                                          <?php
                                          }
