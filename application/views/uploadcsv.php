        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col s12 18">
                    <div class="card x-small">
                        <div class="card-content">
                            <h5 class="card-title activator">Upload CSV Warkah<i class="material-icons right tooltipped" data-position="left" data-delay="50" data-tooltip="Get Code">more_vert</i></h5>
                            <form class="formValidate" id="formValidate" action="<?php echo base_url(); ?>uploadcsv/warkah" method="post" enctype="multipart/form-data">
                              <div class="row">
                                <div class="file-field input-field">
                                    <div class="btn blue darken-1">
                                        <span>File</span>
                                        <input type="file" name="warkah" accept="text/csv">
                                    </div>
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate" type="text">
                                    </div>
