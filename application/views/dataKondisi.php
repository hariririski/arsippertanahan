                ...
                <div class="content">
                  ...
                  <div class="intro-y flex items-center mt-8">
                    <h1 class="text-lg font-medium mr-auto">
                      Master Data Kondisi Pertanahan
                    </h1>
                  </div>

                  <div class="intro-y box p-5 mt-5">
                    <form action="<?php echo base_url(); ?>kondisi/tambah" method="post" enctype="multipart/form-data">
                    <div class="p-5">
                      <div>
                        <label for="change-password-form-1" class="form-label">Kode Kondisi</label>
                        <input id="change-password-form-1" type="number" class="form-control" placeholder="Input text" required name="idKondisi">
                      </div>
                      <div class="mt-3">
                        <label for="change-password-form-2" class="form-label">Nama Kondisi</label>
                        <input id="change-password-form-2" type="text" class="form-control" placeholder="Input text"  required name="namaKondisi">
                      </div>
                      <div class="mt-3">
                  ...
                  <div class="overflow-x-auto intro-y box p-5 mt-5">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        $i=0;
                        foreach($dataKondisi as $data_kondisi){
                          $i++;
                          ?>
                          <tr>
                            <td class="border-b dark:border-dark-5"><?php echo $i; ?></td>
                            <td class="border-b dark:border-dark-5"><?php echo $data_kondisi->idKondisi; ?></td>
                            <td class="border-b dark:border-dark-5"><?php echo $data_kondisi->namaKondisi; ?></td>
                            <td class="border-b dark:border-dark-5">
                              <a href="<?php echo base_url(); ?>lapor/detail_lapor/<?php echo $data_kondisi->idKondisi; ?>">
                              </a>
