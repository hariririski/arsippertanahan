                  ...
                  <div class="intro-y box p-5 mt-5">
                    ...
                    <div class="p-5">
                      <div>
                        ...
                        <input id="change-password-form-1" type="number" class="form-control" placeholder="Input text" required name="id_lemari">
                      </div>
                      <div class="mt-3">
                        <label for="change-password-form-2" class="form-label">Nama Lemari</label>
                        <input id="change-password-form-2" type="text" class="form-control" placeholder="Input text"  required name="nama_lemari">
                      </div>
                      <div class="mt-3">
