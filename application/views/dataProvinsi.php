                  ...
                  <div class="intro-y box p-5 mt-5 ">
                    ...
                    <div class="p-5">
                      <div>
                        ...
                        <input id="change-password-form-1" type="number" class="form-control" placeholder="Input text" required name="idProv">
                      </div>
                      <div class="mt-3">
                        <label for="change-password-form-2" class="form-label">Nama Provinsi</label>
                        <input id="change-password-form-2" type="text" class="form-control" placeholder="Input text"  required name="namaProv">
                      </div>
                      ...
                      <tbody>
                        ...
                        foreach($dataProvinsi as $dataProvinsi){
                          ...
                          <tr>
                            ...
                            <td class="border-b dark:border-dark-5"><?php echo $dataProvinsi->idProv; ?></td>
                            <td class="border-b dark:border-dark-5"><?php echo $dataProvinsi->namaProv; ?></td>
                            <td class="border-b dark:border-dark-5">
                              <a href="<?php echo base_url(); ?>lapor/detail_lapor/<?php echo $dataProvinsi->idProv; ?>">
                              </a>
