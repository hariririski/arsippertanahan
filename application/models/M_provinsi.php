<?php
    class M_provinsi extends CI_Model{
      ...
      function data_desa_bundel(){
        $query=$this->db->query("SELECT kec.nama_kec, desa.id_desa, desa.nama_desa FROM prov INNER JOIN kota on prov.id_prov=kota.id_prov INNER join kec on kec.id_kota=kota.id_kota INNER join desa on desa.id_kec=kec.id_kec ORDER BY kec.nama_kec");
        return $query->result();
      }
}
