<?php
    class M_surat_ukur extends CI_Model{
      ...
      function hapus($id){
        $query=$this->db->query("DELETE FROM `surat_ukur` WHERE surat_ukur.id_surat_ukur='$id'");
        return $query;
      }
